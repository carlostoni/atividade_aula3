...
def atualizar_entradas(event):
    if empresa_var.get() == 'Empresa 5':
        ...
        entry1.config(state='desabilitado')
        entry2.config(state='desabilitado')
        entry3.config(state='desabilitado')
        entry4.config(state='desabilitado')
        entry5.config(state='desabilitado')
